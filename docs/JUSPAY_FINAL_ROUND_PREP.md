...
**Ideal:** Event loop on one thread; non-blocking I/O; Prisma uses connection pool to Postgres; CPU work blocks lo**op if sync.**  
...
#### Q181. What is DNS? Walk through resolving [google.com](http://google.com)
...
#### Q184. What happens when user loads [https://yourapp.com/interview-prep](https://yourapp.com/interview-prep)?
